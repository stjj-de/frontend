...
<script>
  ...
  import UpdateVideoMutation from "./updateVideoMutation.graphql";
  import DeleteVideoMutation from "./deleteVideoMutation.graphql";
  ...
  export default {
    ...
    methods: {
      ...
      async fetchVideo() {
        ...
        const { data: { video } } = await this.$apollo.query({
          query: VideoQuery,
          variables: {
            id: videoId
          },
        ...
        await this.$apollo.mutate({
          ...
          variables: {
            ...
            video: {
              ...
              publicationDate: this.savedVideo.publicationDate === this.publicationDate
                ? undefined
